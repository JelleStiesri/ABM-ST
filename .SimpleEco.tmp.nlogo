...
"" ""
PENS
"Rich" 1.0 0 -2674135 true "" "plot sum [ balance ] of turtles with [ balance >= rich]"
"Poor" 1.0 0 -7500403 true "" "plot sum [ balance ] of turtles with [ balance <= poor]"
"Neutral" 1.0 0 -13840069 true "" "plot sum [ balance ] of turtles with [ balance > poor and balance < rich ]"
...
"" ""
PENS
"B" 5.0 1 -14439633 true "" "set-plot-y-range 0 40\nhistogram [ balance ] of turtles"
...
651
511
Average balance of Poor turtles
bottompoor
2
1
11
...
651
564
Average balance of Rich turtles
toprich
2
1
11
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="false">
    ...
    <metric>top10</metric>
    <metric>bottom50</metric>
    <enumeratedValueSet variable="poor">
      <value value="25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="startcap">
      <value value="100"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="spend">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="rich">
      <value value="300"/>
    </enumeratedValueSet>
  </experiment>
  ...
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="false">
    ...
    <metric>top10</metric>
    <metric>bottom50</metric>
    <metric>toprich</metric>
    <metric>bottompoor</metric>
    <enumeratedValueSet variable="poor">
      <value value="25"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="startcap">
    ...
    <enumeratedValueSet variable="stealing">
      <value value="false"/>
      <value value="true"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="rich">
